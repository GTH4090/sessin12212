...
public partial class KhranDbContext : DbContext
{
    public KhranDbContext()
    {
    }

    public KhranDbContext(DbContextOptions<KhranDbContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see http://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseNpgsql("User Id=postgres;Password=12345;Port=5432;Host=localhost;Database=KhranDb");
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Visitor>(entity =>
        {
            ...
            entity.Property(e => e.Id)
                .HasDefaultValueSql("nextval('visitor_id_seq'::regclass)")
                .HasColumnName("id");
